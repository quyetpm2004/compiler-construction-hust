...
int main()
{
  ...
  cubeType = makeArrayType(10, makeArrayType(10, makeArrayType(10, makeIntType())));
  obj = CreateTypeObject("Cube");
  obj->typeAttrs->actualType = cubeType;
  declareObject(obj);

  obj = CreateVariableObject("M");
  obj->varAttrs->type = duplicateType(cubeType);
  declareObject(obj);
...
// thêm 3 đối tượng cục bộ mới trong hàm F
// Hằng: MAX = 100
// Kiểu: Cube = Arr(10,Arr(10,Arr(10,Int)))
// Biến: M : Arr(10,Arr(10,Arr(10,Int)))
