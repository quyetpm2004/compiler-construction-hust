...
// Thêm mã lỗi cho break/continue ngoài vòng lặp
...
struct ErrorMessage errors[31] = {
    ...
    {ERR_BREAK_NOT_IN_LOOP, "Lenh break khong nam trong vong lap."},
    {ERR_CONTINUE_NOT_IN_LOOP, "Lenh continue khong nam trong vong lap."}};
